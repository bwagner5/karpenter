	...
	Context("Reconciliation", func() {
		...
		Context("Insufficient Capacity Error Cache", func() {
			It("should launch instances of different type on second reconciliation attempt with Insufficient Capacity Error Cache fallback", func() {
				fakeEC2API.InsufficientCapacityPools = set.NewSetFromSlice([]interface{}{fake.CapacityPool{CapacityType: v1alpha1.CapacityTypeOnDemand, InstanceType: "inf1.6xlarge", Zone: "test-zone-1a"}})
				ExpectApplied(ctx, env.Client, provisioner)
			...
			It("should launch instances in a different zone on second reconciliation attempt with Insufficient Capacity Error Cache fallback", func() {
				fakeEC2API.InsufficientCapacityPools = set.NewSetFromSlice([]interface{}{fake.CapacityPool{CapacityType: v1alpha1.CapacityTypeOnDemand, InstanceType: "p3.8xlarge", Zone: "test-zone-1a"}})
			...
			It("should launch smaller instances than optimal if larger instance launch results in Insufficient Capacity Error", func() {
				fakeEC2API.InsufficientCapacityPools = set.NewSetFromSlice([]interface{}{fake.CapacityPool{CapacityType: v1alpha1.CapacityTypeOnDemand, InstanceType: "m5.xlarge", Zone: "test-zone-1a"}})
			...
			It("should launch instances on later reconciliation attempt with Insufficient Capacity Error Cache expiry", func() {
				...
				fakeEC2API.InsufficientCapacityPools = set.NewSet()
			...
			It("should launch on-demand capacity if flexible to both spot and on demand, but spot if unavailable", func() {
				fakeEC2API.InsufficientCapacityPools = set.NewSetFromSlice([]interface{}{fake.CapacityPool{CapacityType: v1alpha1.CapacityTypeSpot, InstanceType: "m5.large", Zone: "test-zone-1a"}})
